...
#Creating users
u1 = User(user_name = "Joan Nyawira", location ="Nairobi")
u2 = User(user_name = "Emma Kori" ,location ="Mombasa")
u3 = User(user_name = "Mary Ivy" ,location ="Embu")
u4 = User(user_name = "Aisha Juma" ,location ="Lamu")
u5 = User(user_name = "Misheck Kajuu", location ="Nyeri")
u6 = User(user_name = "Darryl Mbae" ,location ="Meru")
u7 = User(user_name = "Blair Shiv" ,location ="Malindi")
